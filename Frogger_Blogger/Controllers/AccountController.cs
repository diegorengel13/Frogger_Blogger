            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var email = new MailMessage(emailfrom, model.Email)
                    {
                        ...
                        Body = "please Confirm your account by clicking on link <a href=\"" + callbackUrl + "\">here</a>",
                        IsBodyHtml = true
                    };
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var email = new MailMessage(emailfrom, model.Email)
                {
                    ...
                    Body = "please Reset your account by clicking on link <a href=\"" + callbackUrl + "\">here</a>",
                    IsBodyHtml = true
                };
